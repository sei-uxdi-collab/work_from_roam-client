          ...
          <div className="my-favorite-stars">
            <StarRatingComponent
             ...
             renderStarIcon={(nextValue, prevValue) =>
               (nextValue <= prevValue) ?
                 <img src="star-icon.svg" className="my-favorite-star" alt="star"/> :
                 <img src="star-icon-empty-gray.svg" className="my-favorite-star" alt="star"/>}
            />
          </div>
        </Row>
        <Row className="pb-2">
          ...
          <Col xs={1} className="m-0 p-0" onClick={() => showWorkspace(workplace.id, workplace.place_id)}>
            <span><svg  className="favorites-right-arrow" width="17" height="14" viewBox="0 0 17 14" fill="none" xmlns="http://www.w3.org/2000/svg">
