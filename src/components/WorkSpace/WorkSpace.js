...
class WorkSpace extends React.Component {
    ...
    render() {
      ...
      if (this.props.placeData && this.props.placeData.photos[0]) {
        photo = this.props.placeData.photos[0].getUrl()
      }
      if (this.props.placeData && this.props.placeData.photos[1]) {
        photo1 = this.props.placeData.photos[1].getUrl()
      }
      if (this.props.placeData && this.props.placeData.photos[2]) {
        photo2 = this.props.placeData.photos[2].getUrl()
      }
      if (this.props.placeData && this.props.placeData.photos[3]) {
        photo3 = this.props.placeData.photos[3].getUrl()
      }
      if (this.props.placeData && this.props.placeData.photos[4]) {
